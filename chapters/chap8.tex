...
\item Migrar la herramienta como aplicación móvil mediante el plugin Apache Cordova, de forma que la herramienta no quede ligada al uso mediante navegador web.
