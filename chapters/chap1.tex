...
\item Capítulo \ref{ch:state_of_the_art}, \textit{\nameref{ch:state_of_the_art}}, incluye una descripción de los diferentes tipos de simuladores (de lenguaje \gls{ensamblador} y de \gls{microcodigo}), presentando el trabajo relacionado y una descripción de las tecnologías web actuales.
...
\item Capítulo \ref{ch:implementation_and_deployment}, \textit{\nameref{ch:implementation_and_deployment}}, incluye los detalles de implementación de las partes principales del \gls{software} desarrollado y las características necesarias para la implementación de la aplicación.
...
\item Apéndice A, \textit{\nameref{ch:apendicea}}, incluye el resumen del proyecto en inglés.

\item Apéndice B, \textit{\nameref{ch:apendiceb}}, incluye un manual de usuario de la herramienta.
